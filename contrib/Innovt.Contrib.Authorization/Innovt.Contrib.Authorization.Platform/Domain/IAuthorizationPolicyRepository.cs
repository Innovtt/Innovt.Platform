...
{
    public interface IAuthorizationPolicyRepository :IAuthorizationRepository
    {   
        ...
        Task<Group> GetGroupBy(string name, CancellationToken cancellationToken = default);
        ...
        Task<IList<Permission>> GetPermissionsBy(string scope = null, string resource = null, string name = null,

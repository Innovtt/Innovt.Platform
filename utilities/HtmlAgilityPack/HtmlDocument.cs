...
namespace HtmlAgilityPack
{
    ...
    public class HtmlDocument : IXPathNavigable
    {
        ...
        private int _c;
        private int qtdOpenBraquets;
        private int qtdCloseBraquets;
        ...
        private bool NewCheck()
        {
            ...
            {
                if (_text[_index] == '{' || _text[_index] == ':' || _text[_index] != '@')
                {
                    switch (_state)
                    {
                ...
                switch (_state)
                {
                    ...
                    case ParseState.QuotedAttributeValue:
                        ...
                        if (_c == '@')
                        {
                            if (_index < _text.Length)
                            {
                                //se o proximo nao eh @ entao eh server side code
                                if (_text[_index] != '@')
                                {
                                    _oldstate = _state;
                                    _state = ParseState.ServerSideCode;
                    ...
                    case ParseState.ServerSideCode:
                        ...
                        if (_c == '}')
                        {
                            ...
                            {
                                //ta fechando?
                                if (qtdOpenBraquets == qtdCloseBraquets)
                                {
                                    qtdOpenBraquets = qtdCloseBraquets = 0;

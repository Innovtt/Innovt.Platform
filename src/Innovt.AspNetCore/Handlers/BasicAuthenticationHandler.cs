...
namespace Innovt.AspNetCore.Handlers
{
    public class BasicAuthenticationHandler : AuthenticationHandler<AuthenticationSchemeOptions>
    {
        ...
        public BasicAuthenticationHandler(IOptionsMonitor<AuthenticationSchemeOptions> options, ILoggerFactory logger,
            UrlEncoder encoder, ISystemClock clock, IBasicAuthService authService) : base(options, logger, encoder, clock)
        {
        ...
        private static AuthenticateResult Success(string username)
        {
            ...
            return AuthenticateResult.Success(new AuthenticationTicket(principal, authenticationScheme: SchemeName));
        }

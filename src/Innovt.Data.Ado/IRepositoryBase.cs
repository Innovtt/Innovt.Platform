...
namespace Innovt.Data.Ado
{
    public interface IRepositoryBase
    {
        ...
        Task<PagedCollection<T>> QueryPagedAsync<T>(string sql, IPagedFilter filter, bool automaticQueryCount = true, CancellationToken cancellationToken = default) where T : class;

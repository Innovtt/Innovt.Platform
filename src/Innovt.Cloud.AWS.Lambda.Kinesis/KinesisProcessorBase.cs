...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="KinesisProcessorBase{TBody}"/> class with optional logging and batch failure reporting.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="KinesisProcessorBase{TBody}"/> class with optional batch failure reporting.
    /// </summary>
    /// <param name="reportBatchFailures">Specifies whether to report batch processing failures.</param>

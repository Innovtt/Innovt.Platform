...
{
    public class BidDataModel : Anticipation.BaseDataModel
    {
        public BidDataModel()
        {
            EntityType = "Bid";
        ...
        public string EntityTypeCreatedAt { get => $"ET#{EntityType}#CREATED#{CreatedAt:yyyy-MM-ddTHH:mm:ss.000Z}"; set => _ = value; }

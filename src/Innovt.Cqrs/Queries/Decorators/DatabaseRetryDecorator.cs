...
///     null.
/// </exception>
public sealed class DatabaseRetryDecorator<TFilter, TResult>(IQueryHandler<TFilter, TResult> queryHandler, ILogger logger, int retryCount = 3) : BaseDatabaseRetryDecorator(logger, retryCount),

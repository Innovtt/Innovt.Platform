...
namespace Innovt.Domain.Security
{
    public interface IAuthorizationRepository
    {
        ...
        Task<AuthUser> GetUser(string userId, string scope = null, CancellationToken cancellationToken = default);

        //Task<IList<Permission>> GetUserPermissions(string userId, string scope = null, CancellationToken cancellationToken = default);        

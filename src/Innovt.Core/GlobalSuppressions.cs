...
[assembly:
    SuppressMessage("Naming", "CA1716:Identifiers should not match keywords", Justification = "<Pending>",
        Scope = "member", Target = "~M:Innovt.Core.CrossCutting.Log.ILogger.Error(System.String,System.Object[])")]
[assembly:
    SuppressMessage("Usage", "CA2229:Implement serialization constructors", Justification = "<Pending>", Scope = "type",
        Target = "~T:Innovt.Core.Exceptions.BusinessException")]
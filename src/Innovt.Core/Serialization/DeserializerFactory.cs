...
public class DeserializerFactory
{
    ...
    /// <param name="key">
    ///     The key used to identify the type mapping. If not provided, the full name of the type will be used as
    ///     the key.
    /// </param>
    ...
    /// <returns>
    ///     The deserialized object of the registered type, or <c>null</c> if the key is not found or the content is
    ///     empty.
    /// </returns>
    ...
    /// <param name="content">The JSON content to deserialize.</param>
    /// <returns>
    ///     The deserialized object of the specified type, or the default value for <typeparamref name="T" /> if the key
    ///     is not found or the content is empty.
    /// </returns>
